...
if (isset($_GET['modify_user_patient'])){
    ...
    header("Location: ../index.php?p=unique_patient&print=".$_GET['print']."&edit=1");
}
...
if (isset($_GET['add_statut'])){
    ...
    header("Location: ../index.php?p=unique_patient&print=".$_GET['print']."&add=1");
}
...
if (isset($_GET['delete_statut'])){
    ...
    header("Location: ../index.php?p=unique_patient&print=".$_GET['print']."&delete=1");
}
